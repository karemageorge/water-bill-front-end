...
@Component({
  ...
  templateUrl: './payment-exceptions.component.html',
  styleUrls: ['./payment-exceptions.component.css']
})
export class PaymentExceptionsComponent implements OnInit {
  ...
  selecteditem : any
  displayedColumns : string[] = ["Date","Transaction_Number","Type","Amount","Phone_Number","Name","Shortcode","Account_Number","Receipt_Details"]
  schemes : any[] = []
  dtSource : any[] = [
    {customerName : "george"},
    {customerName : "mark"},
