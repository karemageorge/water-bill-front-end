...
export class DisconnectComponent implements OnInit {
      ...
      DisconnectionTypes : any[] = ["Suspected Self Reconnection", "Put Through", "Plugged at the service line", "Plugged at the saddle","Normal Disconnection","Disconnected on owners request"]
      routedisable = false
    ...
    onRoute(route: any){
        ...
        onSubmit(form : NgForm){
          ...
          const tskType = "Disconnection"
          const tskAssignedTo = this.usrID


          this.disconnection_type = form.value?.DisconnectionType
          ...
          &dcnId=`+this.dcnId+`&disconnection_type=`+this.disconnection_type+`&tsk_pd_id=`+pid+`&customerType_id=&tskdMonths_id=&tskdBalance_id=`+this.balance+`&tskAssigned_to=`+tskAssignedTo+`&tskStart_date=
