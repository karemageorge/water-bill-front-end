...
@Component({
  selector: 'app-replacement-approval',
  templateUrl: './replacement-approval.component.html',
  styleUrls: ['./replacement-approval.component.css']
})
export class ReplacementApprovalComponent implements OnInit {
