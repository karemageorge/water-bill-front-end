...
@Component({
  selector: 'app-issuing-approval',
  templateUrl: './issuing-approval.component.html',
  styleUrls: ['./issuing-approval.component.css']
})
export class IssuingApprovalComponent implements OnInit {
