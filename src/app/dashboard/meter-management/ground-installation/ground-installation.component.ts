...
@Component({
  selector: 'app-ground-installation',
  templateUrl: './ground-installation.component.html',
  styleUrls: ['./ground-installation.component.css']
})
export class GroundInstallationComponent implements OnInit {
